...
func ListServices(c *gin.Context) {
	...
	resp, err := svc.ListServices(clusterID, req.Namespace, req.Page, req.PageSize, req.Keyword)
	if err != nil {
...
func GetServiceDetail(c *gin.Context) {
	...
	data, err := service.GetServiceDetail(clusterID, namespace, name)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": err.Error()})
		return
	}
...
func CreateService(c *gin.Context) {
	...
	data, err := service.CreateService(clusterID, namespace, &svc)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": err.Error()})
		return
	}
...
func UpdateService(c *gin.Context) {
	...
	data, err := service.UpdateService(clusterID, namespace, &svc)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": err.Error()})
		return
	}
...
func DeleteService(c *gin.Context) {
	...
	if err := service.DeleteService(clusterID, req.Namespace, req.Name); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"message": err.Error()})
		return
	}
