    ...
    "paths": {
        ...
        "/k8s/cronjob/suspend": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "参数: {clusterName, namespace, name, suspend}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/k8s/cronjob/yaml/update": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "参数: {clusterName, namespace, name, yaml}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/k8s/namespace/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "参数: {clusterName, name}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
