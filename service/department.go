...
// Update 更新部门
func (s *DepartmentService) Update(id uint, dept *models.Department) error {
	var existDept models.Department
...
// GetList 获取部门列表
func (s *DepartmentService) GetList(deptName, status string) ([]models.Department, error) {
...
func (s *DepartmentService) GetTreeList() ([]models.Department, error) {
	var depts []models.Department
