...
// GetList 获取操作日志列表
func (s *OperationLogService) GetList(page, pageSize int, module, operatorName string) ([]models.OperationLog, int64, error) {
...
func (s *OperationLogService) Delete(id uint) error {
	return database.Db.Delete(&models.OperationLog{}, id).Error
}
